...
describe('Coffee Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'coffee', component: CoffeeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to coffeeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCoffeeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCoffeeIdentifier).toHaveBeenCalledWith(entity);
